...
- **三种模式**：顺序 / 错题 / 模拟考试（**40 分钟 / 30 题（20 单选 + 10 判断）/ 每题 5 分，满分 150**，可暂停/退出、交卷后错题号回顾，**考试中禁止打开笔记**）
- **考试伪随机 + 次数**：按考试次数分组抽题，**每 5 次覆盖全部题目**；待开始页显示**当前第几次考试**与循环轮数
- **考试题号导航**：考试中显示题号按钮，未答白 / 答对绿 / 答错蓝，点击直接跳转
