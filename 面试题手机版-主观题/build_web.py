...
读取：../面试题刷题软件-主观题/题库.json + ../面试题刷题软件-主观题/imgs + www/template.html
输出：www/index.html + 根目录「面试刷题-主观题.html」+ android/app/src/main/assets/index.html
"""
import sys, io, os, json, base64
sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding="utf-8", line_buffering=True)

HERE = os.path.dirname(os.path.abspath(__file__))
DESK = os.path.join(os.path.dirname(HERE), "面试题刷题软件-主观题")
...
FRIENDLY = os.path.join(HERE, "面试刷题-主观题.html")
